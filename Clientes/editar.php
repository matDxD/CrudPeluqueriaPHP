...
if (isset($_POST['grabar']) && $_POST['grabar'] == "si") {
    $alu->editara($_POST['id'], $_POST['nombreC'], $_POST['Correo'], $_POST['Numero']);
    exit();
}

$reg = $alu->get_ida($_GET['id']);
            ...
            <form name="form" action="editar.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nombreC" class="input-padron" value="<?php echo $reg[0]['nombreC'];?>">
                        </div>
                        <div class="col-md-6">
                            <label for="Correo">CORREO</label>
                            <input type="email" name="Correo" class="input-padron" value="<?php echo $reg[0]['Correo'];?>">
                        </div>
                        <div class="col-md-6">
                            <label for="Numero">NUMERO</label>
                            <input type="number" name="Numero" class="input-padron" value="<?php echo $reg[0]['Numero'];?>">
                        </div>

                        <div class="col-md-12">
                            <br>
                            <input type="button" class="enviar" value="VOLVER" onclick="window.location='./menuc.php'">
                            <input type="submit" class="enviar" value="EDITAR" onclick="window.location='./menuc.php'">
                        </div>
                </form>
            </div>
    </section>
